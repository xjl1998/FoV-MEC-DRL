function [result,result1,result2,status] = cvx_optimization_RIS(BW,old_u,unit_num,omegas,epsilon,epsilon_fix,NumberOfFov,NumberOfBS,NumberofAntenna,h_bn,h_rn,h_br,N_0,R_min)
